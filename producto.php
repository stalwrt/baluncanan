...
<head>
    <title>Balún Canan | Tienda Online</title>
    <meta charset="utf-8">
    ...
    <!--| Icono de la página -->
    <link rel="icon" href="assets/mug-hot-solid.svg">
</head>
            ...
            success: function(data) {
                ...
                for (var i = 0; i < data.datos.length; i++) {
                    if (data.datos[i].codpro == p) {
                        document.getElementById("idimg").src = "assets/products/" + data.datos[i]
                            .rutimapro;
                        document.getElementById("idtitle").innerHTML = data.datos[i].nompro;
                        document.getElementById("idprice").innerHTML = formato_precio(data.datos[i]
                            .prepro);
