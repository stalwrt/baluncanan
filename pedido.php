...
<body>
    ...
    <div class="main-content">
        <div class="content-page pedidos">
            <h3>Mis pedidos</h3>
            <div class="body-pedidos" id="space-list">
            </div>
            <h3>Datos de pago</h3>
            <div class="p-line">
                <div>MONTO TOTAL:</div>$.&nbsp;<span id="montototal"></span>
            </div>
            <div class="p-line">
                <div>Banco:</div>BCP
            </div>
            ...
            <p><b>NOTA:</b> Para confirmar la compra debe realizar el deposito por le monto total, y enviar el
                comprobante al siguiente correo example@example.com o al número de whatsapp 999 666 333</p>
        </div>
    </div>
