...
<head>
    <title>Balún Canan | Carrito</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="main-content">
        <div class="content-page">
            <h3 class="titulo-carro">Mi carrito</h3>
            ...
            success: function(data) {
                ...
                for (var i = 0; i < data.datos.length; i++) {
                    html +=
                        ...
                        '<button class="btn-delete-cart" onclick="delete_product(' + data.datos[i]
                        .codped + ')">Eliminar</button>' +
                        '</div>' +
                        '</div>';
